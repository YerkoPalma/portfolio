...
router.addRoute('/:project', require('./views/projects'), function (params) {
  ...
  document.getElementById('projectBody').appendChild(currentProject.body)
})
